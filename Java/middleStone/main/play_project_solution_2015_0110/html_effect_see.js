...
var test_html_file_name = "music_sample.html";
...
var music_channel4 = "player4.html";
...
http.createServer(function(req,res){
	...
	switch(ext){	 
		...
		default:
			...
			if(params.query == 'player4')   // push the index html page
			{	
					res.writeHead(200,{'Content-Type':'text/html'});
					res.write(fs.readFileSync(legal_name_check(music_channel4)));
					res.end();
			}
